...
{
    /// <inheritdoc />
    public partial class UpdateAirplaneRepairServices : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AirplaneRepairServiceAirplaneRepairService",
                columns: table => new
                {
                    AirplaneRepairServiceId = table.Column<int>(type: "int", nullable: false),
                    AirplaneRepairServicesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AirplaneRepairServiceAirplaneRepairService", x => new { x.AirplaneRepairServiceId, x.AirplaneRepairServicesId });
                    table.ForeignKey(
                        name: "FK_AirplaneRepairServiceAirplaneRepairService_AirplaneRepairSer~",
                        column: x => x.AirplaneRepairServiceId,
                        principalTable: "AirplaneRepairServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AirplaneRepairServiceAirplaneRepairService_AirplaneRepairSe~1",
                        column: x => x.AirplaneRepairServicesId,
                        principalTable: "AirplaneRepairServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AirplaneRepairServiceAirplaneRepairService_AirplaneRepairSer~",
                table: "AirplaneRepairServiceAirplaneRepairService",
                column: "AirplaneRepairServicesId");
